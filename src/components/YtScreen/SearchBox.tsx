              ...
              items?.length > 0
                ? items?.map((item: SearchResult, index: number) => (
                    <div key={item.url} className="">
                      <div className="p-4 lg:p-[0.75vw] w-[25vw] lg:w-[15vw] bg-[#333] rounded-lg">
        ...
        >
          ...
          <div className={`${styles.inputContainer} flex-1`}>
            <span className="absolute left-3 top-[50%] translate-y-[-50%]">
              <img src={searchIcon} alt="s" className="h-6 lg:h-[1.25vw]" />
            </span>
            <div>
              <input
                ref={this.inputRef}
                ...
                className="input w-full px-14 lg:text-[0.8vw] lg:placeholder:text-[0.8vw] lg:py-[1vw] lg:px-[2.5vw] py-6 text-lg rounded-xl text-gray bg-white/90 border-none focus:outline-0 focus:border-none focus:ring-0"
              />
            </div>
